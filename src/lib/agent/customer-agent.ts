...
export const AGENT_TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description:
      ...
      "המערכת מטפלת בכל הלוגיקה: אם השעה פנויה אצל הספר היא מעבירה מיד; אם הלקוח לא קפדן לגבי הספר (או לקוח חדש) והשעה פנויה אצל ספר אחר היא מעבירה לשם; ואם השעה תפוסה היא מחזירה לך גם את הזמנים הפנויים הכי קרובים וגם ציון שיש אפשרות לנסות לשחרר בדיוק את השעה שביקש (באישור הספר והלקוח שיושב שם). " +
      "קרא את הטקסט שחוזר מהכלי מילה במילה והצג ללקוח את שתי האפשרויות יחד — הוא לא צריך להתעקש כדי שתציע לו את אפשרות שחרור השעה המדויקת, זו אפשרות רגילה לגמרי לצד הזמנים הפנויים. תן לו לבחור: אם הוא בוחר אחד מהזמנים הפנויים, קרא שוב עם השעה שבחר; אם הוא מעדיף לנסות לשחרר את השעה המקורית, קרא שוב עם insistExactTime=true. " +
    ...
    input_schema: {
      ...
      properties: {
        ...
        insistExactTime: { type: "boolean", description: "true כשהלקוח בחר לנסות לשחרר את השעה המדויקת שביקש (במקום אחד הזמנים הפנויים) — אחרי ששמע את שתי האפשרויות יחד, לא רק אם 'התעקש'. ברירת מחדל false. כשהוא true המערכת מתחילה תהליך אישור מול הספר והלקוח האחר." },
      },
