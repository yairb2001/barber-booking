...
function buildSystemPrompt(params: {
  ...
  return `אתה ${params.agentName}, העוזר החכם של ${params.businessName} — מספרה.
...
8. אשר: "אז ${params.businessName}: [שם ספר], [שירות], [יום תאריך] בשעה [שעה] — נכון?"
...
- אם אינך יכול לעזור — קרא ל-escalate_to_human${faqText}`;
}
