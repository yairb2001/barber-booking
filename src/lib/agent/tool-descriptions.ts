...
export const TOOL_DESCRIPTIONS: Record<string, { description: string; params?: Record<string, string> }> = {
  ...
  propose_booking: {
    description: "מציע ללקוח את התור לאישור סופי. קרא כשיש ספר, שירות, יום ושעה (ושם מלא ללקוח חדש). המערכת שולחת את שאלת האישור הקבועה, ואם הלקוח עונה כן — קובעת בעצמה ומודיעה לו. אתה לא כותב את שאלת האישור ולא קובע בעצמך.",
  },
  opt_out_of_messages: {
