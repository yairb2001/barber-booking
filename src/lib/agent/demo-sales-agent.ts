...
function fallbackPitch(): string {
  return "דרך אגב — זה בדיוק איך זה עובד אצל לקוחות אמיתיים. אם זה נראה לך שימושי לעסק שלך, תשאיר לי מספר טלפון ואחזור אליך.";
}
  ...
  try {
    const res = await anthropic.messages.create({
      ...
      system:
        ...
        " סיים תמיד בבקשה קצרה וטבעית להשאיר מספר טלפון כדי שנחזור אליו. משפט אחד או שניים בלבד, בלי אימוג'ים מוגזמים, בעברית טבעית כמו הודעת וואטסאפ. החזר רק את ההודעה עצמה, בלי הקדמות.",
      messages: [
