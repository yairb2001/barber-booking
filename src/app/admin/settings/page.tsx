...
export default function AdminSettingsPage() {
  ...
  // Owner notification SCOPE: which push notifications the main manager receives.
  ...
  useEffect(() => {
    fetch("/api/admin/business").then(r => r.json()).then(data => {
      if (data) {
        ...
        if (["all", "mine", "off"].includes(settingsObj.ownerNotifyScope)) setOwnerNotifyScope(settingsObj.ownerNotifyScope);
        // Calendar hours
          ...
          <div className="space-y-5 max-w-xl">
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-6">
              ...
              <div className="space-y-4">
                ...
                {/* ── Owner notification scope (all barbers / mine / off) ── */}
                <div className="col-span-2 mb-2 p-4 rounded-xl bg-slate-50 border border-slate-200">
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div>
...
function WhatsAppTab({
  ...
  return (
    <div className="space-y-5 max-w-xl">
      ...
      {/* QR re-connect — shown once credentials are present (premium own-number) */}
